...
namespace ZWave.Channel.Protocol
{
    ...
    public class TransmissionException : CommunicationException
    {
        ...
        public TransmissionException(string message, Exception inner) : base(message, inner)
        {
        }
    }
    ...
    public class ReponseFormatException : ResponseException
    {
        ...
        public ReponseFormatException(string message, Exception inner) : base(message, inner)
        {
        }
    }
}
